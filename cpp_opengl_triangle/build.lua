...
build_universal_arguments = " -std=c++20 -fuse-ld=mold -I../tracy -lX11 -lGL *.cpp ../tracy/TracyClient.cpp -lpthread -ldl"

build_command = "clang++ -g -O0" ..build_universal_arguments
...
elseif arg[1] == "shipping_test" then
   ...
   print( "Running command: \n ".. build_command_shipping_test .. build_extras )
